...
| `NTNT_NET_ALLOW_PRIVATE` | unset | Allow `std/net` probes and enabled `std/netmon` calls to private/internal targets when each call also passes `allow_private: true` |
