...
When generating `.tnt` files (NTNT language), follow these rules. For complete reference documentation, see:
...
- [AI_AGENT_GUIDE.md](../docs/AI_AGENT_GUIDE.md) - Canonical source of truth for this file
