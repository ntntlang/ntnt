...
pub fn init() -> HashMap<String, Value> {
    ...
    module.insert("sha256".to_string(), Value::NativeFunction {
    ...
    module.insert("sha256_bytes".to_string(), Value::NativeFunction {
    ...
    module.insert("hmac_sha256".to_string(), Value::NativeFunction {
    ...
    module.insert("uuid".to_string(), Value::NativeFunction {
        name: "uuid".to_string(),
        arity: 0,
        func: |_args| {
    ...
    module.insert("random_bytes".to_string(), Value::NativeFunction {
    ...
    module.insert("random_hex".to_string(), Value::NativeFunction {
    ...
    module.insert("hex_encode".to_string(), Value::NativeFunction {
    ...
    module.insert("hex_decode".to_string(), Value::NativeFunction {
