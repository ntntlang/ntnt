...
pub fn init() -> HashMap<String, Value> {
    ...
    module.insert("dirname".to_string(), Value::NativeFunction {
    ...
    module.insert("basename".to_string(), Value::NativeFunction {
    ...
    module.insert("extension".to_string(), Value::NativeFunction {
    ...
    module.insert("stem".to_string(), Value::NativeFunction {
        name: "stem".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
    ...
    module.insert("resolve".to_string(), Value::NativeFunction {
    ...
    module.insert("is_absolute".to_string(), Value::NativeFunction {
    ...
    module.insert("is_relative".to_string(), Value::NativeFunction {
    ...
    module.insert("with_extension".to_string(), Value::NativeFunction {
    ...
    module.insert("normalize".to_string(), Value::NativeFunction {
