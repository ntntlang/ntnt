...
pub fn init() -> HashMap<String, Value> {
    ...
    module.insert("post".to_string(), Value::NativeFunction {
        name: "post".to_string(),
        arity: 2,
        func: |args| {
            match (&args[0], &args[1]) {
    ...
    module.insert("put".to_string(), Value::NativeFunction {
        name: "put".to_string(),
        arity: 2,
        func: |args| {
            match (&args[0], &args[1]) {
    ...
    module.insert("delete".to_string(), Value::NativeFunction {
    ...
    module.insert("patch".to_string(), Value::NativeFunction {
    ...
    module.insert("head".to_string(), Value::NativeFunction {
        name: "head".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
    ...
    module.insert("request".to_string(), Value::NativeFunction {
    ...
    module.insert("get_json".to_string(), Value::NativeFunction {
    ...
    module.insert("post_json".to_string(), Value::NativeFunction {
