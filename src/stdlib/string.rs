...
pub fn init() -> HashMap<String, Value> {
            ...
            match &args[0] {
                ...
                Value::String(s1) => {
                    match &args[1] {
                        ...
                        _ => Err(IntentError::TypeError("concat() requires strings".to_string())),
                    }
                }
                _ => Err(IntentError::TypeError("concat() requires strings or array of strings".to_string())),
            }
        },
    });
    
    // repeat(str, count) -> String
    module.insert("repeat".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1]) {
                (Value::String(s), Value::Int(n)) => {
                    if *n < 0 {
                        return Err(IntentError::RuntimeError("repeat count must be non-negative".to_string()));
                    }
                    Ok(Value::String(s.repeat(*n as usize)))
                }
                _ => Err(IntentError::TypeError("repeat() requires string and int".to_string())),
            }
        },
    });
    ...
    module.insert("reverse".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("reverse() requires a string".to_string())),
            }
        },
    });
    ...
    module.insert("trim_left".to_string(), Value::NativeFunction {
        name: "trim_left".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.trim_start().to_string())),
                _ => Err(IntentError::TypeError("trim_left() requires a string".to_string())),
            }
        },
    });
    
    // trim_right(str) -> String - Trim end/right
    module.insert("trim_right".to_string(), Value::NativeFunction {
        name: "trim_right".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.trim_end().to_string())),
                _ => Err(IntentError::TypeError("trim_right() requires a string".to_string())),
            }
        },
    });
    
    // trim_chars(str, chars) -> String - Trim specific characters
    module.insert("trim_chars".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1]) {
                (Value::String(s), Value::String(chars)) => {
                    ...
                    Ok(Value::String(s.trim_matches(|c| char_set.contains(&c)).to_string()))
                }
                _ => Err(IntentError::TypeError("trim_chars() requires two strings".to_string())),
            }
        },
    });
    ...
    module.insert("capitalize".to_string(), Value::NativeFunction {
            ...
            match &args[0] {
                Value::String(s) => {
                    ...
                    match chars.next() {
                        ...
                        Some(first) => {
                            let result: String = first.to_uppercase()
                ...
                _ => Err(IntentError::TypeError("capitalize() requires a string".to_string())),
            }
        },
    });
    
    // title(str) -> String - Title Case Each Word
    module.insert("title".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("title() requires a string".to_string())),
            }
        },
    });
    
    // to_snake_case(str) -> String - "helloWorld" -> "hello_world"
    module.insert("to_snake_case".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("to_snake_case() requires a string".to_string())),
            }
        },
    });
    
    // to_camel_case(str) -> String - "hello_world" -> "helloWorld"
    module.insert("to_camel_case".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("to_camel_case() requires a string".to_string())),
            }
        },
    });
    
    // to_pascal_case(str) -> String - "hello_world" -> "HelloWorld"
    module.insert("to_pascal_case".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("to_pascal_case() requires a string".to_string())),
            }
        },
    });
    
    // to_kebab_case(str) -> String - "hello_world" -> "hello-world"
    module.insert("to_kebab_case".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("to_kebab_case() requires a string".to_string())),
            }
        },
    });
    
    // slugify(str) -> String - "Hello World!" -> "hello-world"
    module.insert("slugify".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("slugify() requires a string".to_string())),
            }
        },
    });
    ...
    module.insert("index_of".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1]) {
                ...
                _ => Err(IntentError::TypeError("index_of() requires two strings".to_string())),
            }
        },
    });
    
    // last_index_of(str, substr) -> Int (-1 if not found)
    module.insert("last_index_of".to_string(), Value::NativeFunction {
        name: "last_index_of".to_string(),
        arity: 2,
        func: |args| {
            match (&args[0], &args[1]) {
                (Value::String(s), Value::String(substr)) => {
                    match s.rfind(substr.as_str()) {
                        Some(idx) => Ok(Value::Int(idx as i64)),
                        None => Ok(Value::Int(-1)),
                    }
                }
                _ => Err(IntentError::TypeError("last_index_of() requires two strings".to_string())),
            }
        },
    });
    
    // count(str, substr) -> Int - Count occurrences
    module.insert("count".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1]) {
                ...
                _ => Err(IntentError::TypeError("count() requires two strings".to_string())),
            }
        },
    });
    ...
    module.insert("replace_all".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(IntentError::TypeError("replace_all() requires three strings".to_string())),
            }
        },
    });
    ...
    module.insert("chars".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("chars() requires a string".to_string())),
            }
        },
    });
    
    // lines(str) -> [String] - Split by newlines
    module.insert("lines".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("lines() requires a string".to_string())),
            }
        },
    });
    
    // words(str) -> [String] - Split by whitespace
    module.insert("words".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("words() requires a string".to_string())),
            }
        },
    });
    
    // truncate(str, max_len, suffix) -> String - Truncate with suffix
    module.insert("truncate".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(IntentError::TypeError("truncate() requires string, int, string".to_string())),
            }
        },
    });
    ...
    module.insert("pad_left".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(IntentError::TypeError("pad_left() requires string, int, string".to_string())),
            }
        },
    });
    
    // pad_right(str, length, char) -> String
    module.insert("pad_right".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(IntentError::TypeError("pad_right() requires string, int, string".to_string())),
            }
        },
    });
    
    // center(str, length, char) -> String - Center with padding
    module.insert("center".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1], &args[2]) {
                ...
                _ => Err(IntentError::TypeError("center() requires string, int, string".to_string())),
            }
        },
    });
    ...
    module.insert("is_empty".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_empty() requires a string".to_string())),
            }
        },
    });
    
    // is_blank(str) -> Bool - Empty or only whitespace
    module.insert("is_blank".to_string(), Value::NativeFunction {
        name: "is_blank".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::Bool(s.trim().is_empty())),
                _ => Err(IntentError::TypeError("is_blank() requires a string".to_string())),
            }
        },
    });
    
    // is_numeric(str) -> Bool - All digits
    module.insert("is_numeric".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_numeric() requires a string".to_string())),
            }
        },
    });
    
    // is_alpha(str) -> Bool - All letters
    module.insert("is_alpha".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_alpha() requires a string".to_string())),
            }
        },
    });
    
    // is_alphanumeric(str) -> Bool - Letters and digits only
    module.insert("is_alphanumeric".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_alphanumeric() requires a string".to_string())),
            }
        },
    });
    
    // is_lowercase(str) -> Bool
    module.insert("is_lowercase".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_lowercase() requires a string".to_string())),
            }
        },
    });
    
    // is_uppercase(str) -> Bool
    module.insert("is_uppercase".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_uppercase() requires a string".to_string())),
            }
        },
    });
    
    // is_whitespace(str) -> Bool
    module.insert("is_whitespace".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match &args[0] {
                ...
                _ => Err(IntentError::TypeError("is_whitespace() requires a string".to_string())),
            }
        },
    });
    
    // matches(str, pattern) -> Bool - Simple glob-like matching (* and ?)
    module.insert("matches".to_string(), Value::NativeFunction {
        ...
        func: |args| {
            match (&args[0], &args[1]) {
                ...
                _ => Err(IntentError::TypeError("matches() requires two strings".to_string())),
            }
        },
    });
    ...
    module.insert("upper".to_string(), Value::NativeFunction {
        name: "upper".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.to_uppercase())),
                _ => Err(IntentError::TypeError("upper() requires a string".to_string())),
            }
        },
    });
    
    // lower(str) -> String (alias for to_lower)
    module.insert("lower".to_string(), Value::NativeFunction {
        name: "lower".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.to_lowercase())),
                _ => Err(IntentError::TypeError("lower() requires a string".to_string())),
            }
        },
    });
    
    // trim_start(str) -> String (alias for trim_left)
    module.insert("trim_start".to_string(), Value::NativeFunction {
        name: "trim_start".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.trim_start().to_string())),
                _ => Err(IntentError::TypeError("trim_start() requires a string".to_string())),
            }
        },
    });
    
    // trim_end(str) -> String (alias for trim_right)
    module.insert("trim_end".to_string(), Value::NativeFunction {
        name: "trim_end".to_string(),
        arity: 1,
        func: |args| {
            match &args[0] {
                Value::String(s) => Ok(Value::String(s.trim_end().to_string())),
                _ => Err(IntentError::TypeError("trim_end() requires a string".to_string())),
            }
        },
    });
