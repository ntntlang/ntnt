...
Read this skill file when working on compiler internals, adding stdlib functions, modifying the interpreter, or any Rust-level changes to the NTNT runtime.
